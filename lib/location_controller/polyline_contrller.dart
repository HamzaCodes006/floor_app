  ...
  void removeMarkers() {
    {
      ...
      // markers.removeWhere((m) => m.markerId.value == "Pick Location");
      update();
    }
  }
...
//SingleToneValue.instance.pickLat=lat1;
//SingleToneValue.instance.pickLng=lng1;
  ...
  Future<void> addMarkers1() async {
    markers.add(Marker(
      ...
      position: SingleToneValue.instance.pickLng==0 && SingleToneValue.instance.pickLat==0 ?
      LatLng(lat1,lng1)
          :LatLng(SingleToneValue.instance.pickLat,SingleToneValue.instance.pickLng),
      infoWindow: InfoWindow(
        title: 'Pick Up',
        // snippet: '${SingleToneValue.instance.pickAddress}',
      ),
  ...
  createPolylines() async {
    ...
    try {
      ...
      PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
        ...
        SingleToneValue.instance.pickLat==0 && SingleToneValue.instance.pickLng==0?
        PointLatLng(lat1, lng1) :
        PointLatLng(SingleToneValue.instance.pickLat, SingleToneValue.instance.pickLng
        ),
  ...
  onMapCreated1(GoogleMapController controller)  {
    try {
      ...
      bound = LatLngBounds(
        northeast: LatLng(
            SingleToneValue.instance.pickLat==0 ? max(lat1,SingleToneValue.instance.currentLat) :
            max(SingleToneValue.instance.pickLat, SingleToneValue.instance.currentLat),
            SingleToneValue.instance.pickLng==0 ? max(lng1, SingleToneValue.instance.currentLng):
            max(SingleToneValue.instance.pickLng, SingleToneValue.instance.currentLat)),
        southwest: LatLng(
            min(SingleToneValue.instance.pickLat,SingleToneValue.instance.currentLat),
            min(SingleToneValue.instance.pickLng, SingleToneValue.instance.currentLng)),
      );
